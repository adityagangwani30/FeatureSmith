...
- **[Future]** As an MLOps engineer, I want to export accepted feature engineering steps as a versioned `sklearn.Pipeline` (or equivalent) with unit tests, so it's CI-testable. (v0.5.)
